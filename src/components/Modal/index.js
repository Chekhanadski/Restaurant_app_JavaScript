export default class Modal {
  constructor() {
    ...
    this.elem
      ...
      .addEventListener("click", this.close); // вешаем на кнопку закрытия модального окна событие 'click', описаное в методе Close; 2-ой - закрытие по клику по кнопке [x], которая содержит класс modal__close
