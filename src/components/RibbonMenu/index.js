export default class RibbonMenu {
  constructor(categories) {
    ...
    this.scrollInner.addEventListener("scroll", (event) =>
      this.buttonHide(event)
    );

    this.scrollInner.addEventListener("click", (event) =>
  ...
  selection(event) {
    ...
    let selectionElement = this.scrollInner.querySelector(
      ".ribbon__item_active"
    );
    element.classList.add("ribbon__item_active");
    let selectionAllElements = this.scrollInner.querySelectorAll(
      ".ribbon__item_active"
    );
    ...
    let eventCustome = new CustomEvent("ribbon-select", {
      bubbles: true,
      detail: element.getAttribute("data-id"),
    });
  ...
  buttonHide(event) {
    let scrollRight =
      this.scrollInner.scrollWidth -
      this.scrollInner.scrollLeft -
      this.scrollInner.clientWidth;
